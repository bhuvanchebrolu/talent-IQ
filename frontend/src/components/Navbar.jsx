...
function Navbar() {
 const location=useLocation();
  ...
  return (
    <nav className="bg-base-100/80 backdrop-blur-md border-b border-primary/20 sticky top-0 z-50 shoadow-lg">
      <div className="max-w-7xl mx-auto p-4 flex items-center justify-between">
        ...
        >
          <div
            className="size-10 rounded-xl bg-gradient-to-r from-primary via-secondary to-accent
